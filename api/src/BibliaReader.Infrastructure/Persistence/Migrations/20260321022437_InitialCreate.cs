        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnswerMarkdown = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetChaptersPerDay = table.Column<int>(type: "integer", nullable: true),
                    Deadline = table.Column<DateOnly>(type: "date", nullable: true),
                    BookAbbreviation = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScopeBookIdsJson = table.Column<string>(type: "text", nullable: true),
                    PaceMode = table.Column<int>(type: "integer", nullable: false),
                    ChaptersPerDay = table.Column<int>(type: "integer", nullable: true),
                    ...
                    TotalChaptersInScope = table.Column<int>(type: "integer", nullable: false),
                    BibleVersionId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReadingPlans_BibleVersions_BibleVersionId",
                        column: x => x.BibleVersionId,
                        principalTable: "BibleVersions",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudyLessons", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudyLessons_Studies_StudyId",
                        column: x => x.StudyId,
            ...
            migrationBuilder.CreateTable(
                name: "UserStudyProgressEntries",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    StudyId = table.Column<Guid>(type: "uuid", nullable: false),
                    LastCompletedLessonId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserStudyProgressEntries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserStudyProgressEntries_Studies_StudyId",
                        column: x => x.StudyId,
                        principalTable: "Studies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "StudyCategoryLinks",
                columns: table => new
                {
                    StudyId = table.Column<Guid>(type: "uuid", nullable: false),
                    StudyCategoryId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudyCategoryLinks", x => new { x.StudyId, x.StudyCategoryId });
                    table.ForeignKey(
                        name: "FK_StudyCategoryLinks_Studies_StudyId",
                        column: x => x.StudyId,
                        principalTable: "Studies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudyCategoryLinks_StudyCategories_StudyCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    BibleBookId = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ReadingPlanId = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    OccurredAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    ChapterKey = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReadingEvents_ReadingPlans_ReadingPlanId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BibleBooks_BibleVersionId_Abbreviation",
                table: "BibleBooks",
                columns: new[] { "BibleVersionId", "Abbreviation" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BibleChapters_BibleBookId_Number",
                table: "BibleChapters",
                columns: new[] { "BibleBookId", "Number" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BibleVersions_Code",
                table: "BibleVersions",
                column: "Code",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReadingEvents_ReadingPlanId_ChapterKey",
                table: "ReadingEvents",
                columns: new[] { "ReadingPlanId", "ChapterKey" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ReadingEvents_UserId_OccurredAt",
                table: "ReadingEvents",
                columns: new[] { "UserId", "OccurredAt" });

            migrationBuilder.CreateIndex(
                name: "IX_ReadingPlans_BibleVersionId",
                table: "ReadingPlans",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudyCategoryLinks_StudyCategoryId",
                table: "StudyCategoryLinks",
                column: "StudyCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_StudyLessons_StudyId_Order",
                table: "StudyLessons",
                columns: new[] { "StudyId", "Order" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserStudyProgressEntries_StudyId",
                table: "UserStudyProgressEntries",
                column: "StudyId");

            migrationBuilder.CreateIndex(
                name: "IX_UserStudyProgressEntries_UserId_StudyId",
                table: "UserStudyProgressEntries",
                columns: new[] { "UserId", "StudyId" },
                unique: true);
        }
